...
func createSnapshotScheduleAndVerify(
	...
	snapshot, err := stork.Instance().GetSnapshotSchedule(name, namespace)
...
func TestGetSnapshotSchedulesWithStatus(t *testing.T) {
	...
	snapshotSchedule, err := stork.Instance().GetSnapshotSchedule("getsnapshotschedulestatustest", "test")
	require.NoError(t, err, "Error getting snapshot schedule")
	...
	snapshotSchedule, err = stork.Instance().UpdateSnapshotSchedule(snapshotSchedule)
...
func TestSuspendResumeSnapshotSchedule(t *testing.T) {
	...
	snapshotSchedule, err := stork.Instance().GetSnapshotSchedule(name, namespace)
