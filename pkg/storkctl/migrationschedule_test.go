...
func createMigrationScheduleAndVerify(
	...
	migration, err := stork.Instance().GetMigrationSchedule(name, namespace)
...
func TestGetMigrationSchedulesWithStatus(t *testing.T) {
	...
	migrationSchedule, err := stork.Instance().GetMigrationSchedule("getmigrationschedulestatustest", "default")
	require.NoError(t, err, "Error getting migration schedule")
	...
	migrationSchedule, err = stork.Instance().UpdateMigrationSchedule(migrationSchedule)
...
func TestSuspendResumeMigrationSchedule(t *testing.T) {
	...
	migrationSchedule, err := stork.Instance().GetMigrationSchedule(name, namespace)
