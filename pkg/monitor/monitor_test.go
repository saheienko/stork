...
func setup(t *testing.T) {
	...
	storage.SetInstance(storage.New(fakeKubeClient.StorageV1(), fakeKubeClient.StorageV1beta1()))
	stork.SetInstance(stork.New(fakeKubeClient, fakeStorkClient, nil))
...
func testVolumeAttachmentCleanup(t *testing.T) {
	...
	_, err = storage.Instance().CreateVolumeAttachment(&storagev1beta1.VolumeAttachment{
		ObjectMeta: metav1.ObjectMeta{
			Name: "va-healthy",
		},
