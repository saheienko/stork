...
func setup(t *testing.T) {
	...
	core.Instance().SetClient(fakeKubeClient, nil, fakeStorkClient, nil, nil, nil, nil, nil)
...
func testVolumeAttachmentCleanup(t *testing.T) {
	...
	_, err = core.Instance().CreateVolumeAttachment(&storagev1beta1.VolumeAttachment{
		ObjectMeta: metav1.ObjectMeta{
			Name: "va-healthy",
		},
	...
	vaList, err := core.Instance().ListVolumeAttachments()
