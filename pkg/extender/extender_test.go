...
var fakeCorClient *fakeclient.Clientset
var fakeStorageClient *fakeocpclient.Clientset
...
func setup(t *testing.T) {
	...
	fakeCorClient = fakeclient.NewSimpleClientset()
	fakeStorageClient = fakeocpclient.NewSimpleClientset()
